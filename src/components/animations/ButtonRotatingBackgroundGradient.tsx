const ButtonRotatingBackgroundGradient = ({ text }: { text: string }) => {
  return (
    <button className="relative inline-flex h-9 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50">
